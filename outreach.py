...
- وقّع باسم المرسِل كما ورد في الملف، بلا اختراع منصب أو هاتف.
...
- وقّع باسم المرسِل كما ورد في ملفه، بلا اختراع منصب أو هاتف.
...
def _profile_text() -> str:
    try:
        ...
        p = {}
    keep = ("company", "entity_type", "country", "sector", "capabilities",
            "products", "strengths", "outside_country_modes")
